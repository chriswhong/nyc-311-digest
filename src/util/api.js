...
export const useFollowQuery = (_id, sub) => {
  return useFetch({
    url: `${process.env.REACT_APP_API_BASE_URL}/.netlify/functions/post-follow`,
    method: 'POST',
    body: {
      _id,
      sub
...
export const useUnfollowQuery = (_id, sub) => {
  return useFetch({
    url: `${process.env.REACT_APP_API_BASE_URL}/.netlify/functions/post-unfollow`,
    method: 'POST',
    body: {
      _id,
      sub
