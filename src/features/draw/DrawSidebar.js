  ...
  return (
    <div className='px-4'>
      ...
      <div className='mb-4'>
        ...
        <div className='text-xs text-gray-600 mb-2'>Tip: Many 311 requests are geocoded to the center of a street.  Polygons that end mid-block are optimal for capturing all activity on a given street.</div>
