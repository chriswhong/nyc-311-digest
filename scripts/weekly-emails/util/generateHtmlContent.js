                                                    ...
                                                    <tr>
                                                        <td class="r2-c" align="center">
                                                            <table cellspacing="0"
                                                                cellpadding="0" border="0"
                                                                role="presentation"
                                                                width="570" class="r16-o"
                                                                style="table-layout: fixed; width: 570px;">
                                                                <tr
                                                                    class="nl2go-responsive-hide">
                                                                    <td height="1" width="1"
                                                                        style="font-size: 1px; line-height: 1px; background-color: #858588;">
                                                                        ­ </td>
                                                                    <td height="1"
                                                                        style="font-size: 1px; line-height: 1px; background-color: #858588;">
                                                                        ­</td>
                                                                ...
                                                                <tr
                                                                    ...
                                                                    <td height="15"
                                                                        width="1"
                                                                        style="font-size: 15px; line-height: 15px; background-color: #858588;">
                                                                        ­ </td>
                                                                    <td height="15"
                                                                ...
                                                                <tr>
                                                                    <td class="nl2go-responsive-hide"
                                                                        width="1"
                                                                        style="font-size: 0px; line-height: 1px; background-color: #858588;">
                                                                        ­ </td>
                                                                    <td class="r17-i"
...
<head>
    ...
    <title>Weekly NYC 311 Report for Areas You Follow</title>
    ...
    <style type="text/css" emogrify="no">
        @media (max-width: 600px) {
            ...
            .r16-o {
                border-bottom-color: #858588 !important;
                border-bottom-width: 1px !important;
                border-left-color: #858588 !important;
                border-left-width: 1px !important;
                border-right-color: #858588 !important;
                border-right-width: 1px !important;
                border-style: solid !important;
                border-top-color: #858588 !important;
                                                                                ...
                                                                                <tr>
                                                                                    <td class="r8-c" align="center">
                                                                                        <table cellspacing="0"
                                                                                            ...
                                                                                            <tr>
                                                                                                <td class="r10-i"> <a
                                                                                                        href="https://nyc311.app"
                                                                                                        target="_blank"
                                                                                                        style="color: #0092ff; text-decoration: underline;">
                                                                                                        <img src="https://nyc311.app/logo192.png"
                                                                                                            width="115"
                                                                                                            alt="nyc 311 reports logo"
                                                                                                            border="0"
                                                                                                            class=""
                                                                                                            style="display: block; width: 100%;"></a>
                                                                                                </td>
                                                                                    ...
                                                                                    <td class="r12-c" align="left">
                                                                                        <table cellspacing="0"
                                                                                            ...
                                                                                            <tr
                                                                                                class="nl2go-responsive-hide">
                                                                                                <td height="19"
                                                                                                    style="font-size: 19px; line-height: 19px;">
                                                                                                    ­</td>
                                                                                            </tr>
                                                                                        </table>
                                                                                    </td>
                                                                                                ...
                                                                                                <td align="center"
                                                                                                    ...
                                                                                                    <div>
                                                                                                        <p
                                                                                                            ...
                                                                                                            <a href="https://nyc311.app"
                                                                                                                style="color: #0092ff; text-decoration: underline;">https://nyc311.app</a>
                                                                                                        </p>
                                                                                                    </div>
                                                                                                </td>
                                                                                            </tr>
                                                                                                                ...
                                                                                                                <table
                                                                                                                    ...
                                                                                                                    <tr>
                                                                                                                        <td height="48"
                                                                                                                            class=""
                                                                                                                            style="font-size: 0px; line-height: 0px;">
                                                                                                                            <img src="https://img.mailinblue.com/new_images/rnb/en.png"
                                                                                                                                width="129"
                                                                                                                                border="0"
                                                                                                                                class=""
